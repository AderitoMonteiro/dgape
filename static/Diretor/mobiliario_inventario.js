...
document.getElementById("id_deleteCkunlok").addEventListener("click", function () {
    ...
    if (checkboxes.length === 0) {
        ...
        const data = {
            "inventario_mobiliario_id": equipamento_ids,
            "id_user":user_id,
            "X-CSRFToken": getCSRFToken()
        };
        // Configuração da requisição
        jqOld.ajax({
            url: "unlockcheckbox_inventario_mobiliario/",
            type: 'POST',
            data: data,
            success: function (data) {
...
function get_mobiliario_block_inventario(button){

    document.getElementById('lock_inventario_mobiliario').value=button.getAttribute("data-id");
 
 }
 function get_mobiliario_unblock_inventario(button){

    document.getElementById('id_unlok_inventario_mobiliario').value=button.getAttribute("data-id");
 
 }


 function bloquear_mobiliario_inventario(){

    let inventario_mobiliario_id= document.getElementById('lock_inventario_mobiliario').value;
    let user_update= document.getElementById('id_user').value;
    ...
    const data = {
     ...
     jqOld.ajax({
         url: 'lock_inventario_mobiliario/',
         type: 'POST',
         data: data,
         success: function (data) {
...
function get_mobiliario_block_inventario(button){
 ...
 function desbloquear_equipamento_inventario(){
    ...
    let inventario_mobiliario_id= document.getElementById('id_unlok_inventario_mobiliario').value;
    let user_update= document.getElementById('id_user').value;
    ...
    const data = {
     ...
     jqOld.ajax({
         url: 'unlock_inventario_mobiliario/',
         type: 'POST',
         data: data,
         success: function (data) {

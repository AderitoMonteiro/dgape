...
urlpatterns = [
     ...
     path('eleitoral/equipamento/lock_mobiliario_eleitoral/', bloquear_equipamento_eleitoral, name='bloquear_equipamento_eleitoral'),

...
from departamentos.views import get_mobiliario_eleitoral,get_equipamento_eleitoral,get_mobiliario_eleitoral_inventario,get_equipamento_eleitoral_inventario,get_mobiliario_inventario,get_equipamento_inventario
from kit_eleitoral.views import get_kit 
from equipamentos.views import get_equipamento
from mobiliarios.views import get_mobiliario
app_name = "diretor"
urlpatterns = [
